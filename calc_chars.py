# -*- coding: utf-8 -*-
"""
Created on Fri Jan 13 22:20:50 2023
...
def get_ST_PT_info():
    ...
    ST_PT = pd.read_csv('data/csmar_tables/TRD_Dalyr.csv')
...
class Ashare_calc_chars():
    ...
    def drop_FinInd(self, df, table):
        ...
        result = df.copy()
        Ind = pd.read_csv('data/csmar_tables/INDFI_INDTRAJECTORY.csv')
    ...
    def get_data(self, table, field=None, fs_freq='q', lag=True, lag_rule=None):
        ...
        raw_data = pd.read_csv('data/csmar_tables/' + table + '.csv')
    ...
    def calc_age(self):
        ...
        listdate = pd.read_csv('data/csmar_tables/IPO_Cobasic.csv')
